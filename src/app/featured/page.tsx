...
export function generateMetadata(): Metadata {
  ...
  const desc = `Featured AI prompt workflows selected for quality and relevance.`;
  return {
    title: `Featured Workflows — ${suffix}`,
    description: desc,
    openGraph: { title: `Featured Workflows — ${suffix}`, description: desc, type: "website" },
  };
}
